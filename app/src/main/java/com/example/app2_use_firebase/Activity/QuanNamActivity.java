...
import com.example.app2_use_firebase.databinding.ActivityListQuanNamBinding;
...
public class QuanNamActivity extends BaseActivity{
    ActivityListQuanNamBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        binding = ActivityListQuanNamBinding.inflate(getLayoutInflater());
    ...
    private void initQuanNam() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    final List<ItemsDomain> itemsQuanList = soapClient.getItemsQuanNam();
                        ...
                        public void run() {
                            if (itemsQuanList != null && !itemsQuanList.isEmpty()) {
                                ...
                                if (!items.isEmpty()) {
                                    ...
                                    binding.recyclerViewListQuanNam.setAdapter(new PopularAdapter(items));
                                }

                                binding.progressAo.setVisibility(View.GONE);
                            } else {
                                Toast.makeText(QuanNamActivity.this, "Web service connect error", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                } catch (Exception e) {
                        ...
                        public void run() {
                            if (itemsSliderItems != null && !itemsSliderItems.isEmpty()) {
                                ...
                                if (!imageUrls.isEmpty()) {
                                    SliderImgAdapter slideAdapter = new SliderImgAdapter(QuanNamActivity.this, imageUrls);
